...
const CHAT = "https://leaberlin.com";
...
function ThreadsIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.781 3.631 2.695 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 1.79-1.202.065-2.36-.218-3.259-.801-1.063-.689-1.685-1.74-1.752-2.964-.065-1.19.408-2.285 1.322-3.104.915-.82 2.148-1.31 3.663-1.462.856-.086 1.643-.043 2.35.107-.096-.577-.29-1.023-.58-1.335-.4-.43-1.02-.65-1.843-.656h-.033c-.66 0-1.555.182-2.124 1.03l-1.688-1.135C8.19 7.15 9.648 6.42 11.3 6.42h.05c2.76.017 4.406 1.718 4.568 4.68.093.04.185.08.275.124 1.29.606 2.234 1.524 2.73 2.655.69 1.575.75 4.14-1.32 6.208-1.578 1.577-3.492 2.29-6.187 2.31zm1.253-11.9c-.207 0-.417.007-.63.02-1.578.088-2.567.816-2.51 1.85.058 1.087 1.257 1.594 2.41 1.532 1.058-.057 2.43-.47 2.67-3.29-.59-.09-1.204-.113-1.94-.113z" />
    </svg>
  );
}
...
export default function Here() {
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.body}>
          ...
          <a className={styles.rowLink} href={CHAT} target="_blank" rel="noopener" data-ph="chat_row">
            ...
            <span className={styles.rowText}>hier schreiben wir 🤫</span>
      ...
      <p className={styles.footer}>lea · berlin · 18+ · ki-charakter</p>
    </div>
  );
}
